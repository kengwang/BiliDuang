...
namespace MaterialSkin
{
    public class MaterialSkinManager
    {
        ...
        //Flat button
        private static readonly Color FLAT_BUTTON_BACKGROUND_HOVER_LIGHT = Color.FromArgb(ColorExtension.PercentageToColorComponent(20), ColorExtension.ToColor(0x999999));//.ToColor());
        private static readonly Brush FLAT_BUTTON_BACKGROUND_HOVER_LIGHT_BRUSH = new SolidBrush(FLAT_BUTTON_BACKGROUND_HOVER_LIGHT);
        private static readonly Color FLAT_BUTTON_BACKGROUND_PRESSED_LIGHT = Color.FromArgb(ColorExtension.PercentageToColorComponent(40), ColorExtension.ToColor(0x999999));//.ToColor());
        ...
        private static readonly Color FLAT_BUTTON_DISABLEDTEXT_LIGHT = Color.FromArgb(ColorExtension.PercentageToColorComponent(26), ColorExtension.ToColor(0x000000));//.ToColor());
        private static readonly Brush FLAT_BUTTON_DISABLEDTEXT_LIGHT_BRUSH = new SolidBrush(FLAT_BUTTON_DISABLEDTEXT_LIGHT);

        private static readonly Color FLAT_BUTTON_BACKGROUND_HOVER_DARK = Color.FromArgb(ColorExtension.PercentageToColorComponent(15), ColorExtension.ToColor(0xCCCCCC));//.ToColor());
        private static readonly Brush FLAT_BUTTON_BACKGROUND_HOVER_DARK_BRUSH = new SolidBrush(FLAT_BUTTON_BACKGROUND_HOVER_DARK);
        private static readonly Color FLAT_BUTTON_BACKGROUND_PRESSED_DARK = Color.FromArgb(ColorExtension.PercentageToColorComponent(25), ColorExtension.ToColor(0xCCCCCC));//.ToColor());
        ...
        private static readonly Color FLAT_BUTTON_DISABLEDTEXT_DARK = Color.FromArgb(ColorExtension.PercentageToColorComponent(30), ColorExtension.ToColor(0xFFFFFF));//.ToColor());
        ...
        {
            string DefaultFontFaceName = "微软雅黑";
            if (System.Environment.OSVersion.Version.Major < 6)
            {
                DefaultFontFaceName = "宋体";
            }

            ROBOTO_MEDIUM_12 = new Font(DefaultFontFaceName, 12f);// LoadFont(Resources.Roboto_Medium), 12f);
