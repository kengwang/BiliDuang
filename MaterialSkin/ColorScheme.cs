...
namespace MaterialSkin
{
	public class ColorScheme
    {
        ...
        {
            //Color
            PrimaryColor = ColorExtension.ToColor((int)primary);//.ToColor();
            DarkPrimaryColor = ColorExtension.ToColor((int)darkPrimary);//.ToColor();
            LightPrimaryColor = ColorExtension.ToColor((int)lightPrimary);//.ToColor();
            AccentColor = ColorExtension.ToColor((int)accent);//.ToColor();
            TextColor = ColorExtension.ToColor((int)textShade);//.ToColor();
    ...
    public static class ColorExtension
    {
        ...
        /// </summary>
        /// <returns></returns>
        public static Color ToColor(int argb)//this int argb)
        {
        ...
        /// <returns></returns>
        public static Color RemoveAlpha(Color color)//this Color color)
        {
        ...
        /// <returns></returns>
        public static int PercentageToColorComponent(int percentage)//this int percentage)
        {
